...
import timestampEditor from '../pages/timestampEditor/components';
...
const routes = {
  ...
  childRoutes: [
    ...
    { path: 'calendar', name: 'Calendar', component: calendar, childRoutes: [
      { path: 'timestamp-editor', name: 'TimestampEditor', component: timestampEditor},
    ]},
