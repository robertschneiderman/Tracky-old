...
import { sortByInterval } from '../../../common/helpers/common';
...
class Tasks extends Component {
    ...
    renderTasks() {
        ...
        tasks.sort(sortByInterval).forEach((task, i) => {
            let timestamps = task.timestamps.map(id => timestamp[id]);
            let goals = task.goals.map(goalId => goalDictionary[goalId]).sort(this.sortByInterval);  
